        ...
        {stats && (
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-2 mb-4">
            ...
            <div className="bg-white rounded-xl p-3 border border-blue-200 shadow-lg">
              <div className="flex items-center justify-between mb-1">
                <HandThumbUpIcon className="h-5 w-5 text-blue-600" />
                <span className="text-xl font-bold text-gray-900">{stats.totalHelpfulVotes}</span>
              </div>
              <p className="text-blue-700 text-xs">Helpful Votes</p>
            </div>

            <div className="bg-white rounded-xl p-3 border border-orange-200 shadow-lg">
              <div className="flex items-center justify-between mb-1">
                <ClockIcon className="h-5 w-5 text-orange-600" />
                <span className="text-xl font-bold text-gray-900">{stats.pendingCount}</span>
              </div>
              <p className="text-orange-700 text-xs">Pending Review</p>
            </div>

            <div className="bg-white rounded-xl p-3 border border-green-200 shadow-lg">
              <div className="flex items-center justify-between mb-1">
                <CheckCircleIcon className="h-5 w-5 text-green-600" />
                <span className="text-xl font-bold text-gray-900">{stats.approvedCount}</span>
              </div>
