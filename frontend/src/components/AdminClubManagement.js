    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Club Management</h1>
          <p className="text-xl text-gray-700">Review and approve club applications</p>
        </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            <div className="text-gray-900 text-xl">Loading pending clubs...</div>
          </div>
                  ...
                  <div className="flex-1 mr-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <p className="text-gray-900">{club.createdBy?.firstName} {club.createdBy?.lastName}</p>
                        <p className="text-gray-600 text-sm">{club.createdBy?.email}</p>
                      </div>
                      <div>
